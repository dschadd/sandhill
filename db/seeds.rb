User.create!(first_name: "Daniel", last_name: "Schadd", email: "daniel@email.com", password: "password")

User.create!(first_name: "Alvin", last_name: "Kamara", email: "alvin@email.com", password: "password")

User.create!(first_name: "Khalil", last_name: "Mack", email: "khalil@email.com", password: "password")
